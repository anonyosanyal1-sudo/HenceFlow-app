        ...
        >
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-[2.1rem] font-bold text-white leading-tight tracking-tight">
              ...
              <em className="font-serif not-italic" style={{ fontStyle: 'italic', fontFamily: 'Georgia, "Times New Roman", serif' }}>
                HenceFlow
              </em>
            </h1>
          ...
          <div className="flex gap-3">
            <button
              type="button"
              className="flex-1 flex items-center justify-center gap-2.5 h-11 rounded-xl border border-border/60 bg-white/[0.04] text-sm font-medium text-foreground hover:bg-white/[0.08] hover:border-border transition-all"
            >
