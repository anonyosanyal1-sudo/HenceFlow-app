            ...
            <>
              <div className="flex gap-3">
                <button
                  ...
                  disabled
                  aria-disabled="true"
                  title="Social login is not yet configured — use email instead"
                  className="flex-1 flex items-center justify-center gap-2.5 h-11 rounded-xl border border-border/40 bg-white/[0.02] text-sm font-medium text-foreground/30 cursor-not-allowed opacity-50 select-none"
                >
