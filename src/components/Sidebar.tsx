                  ...
                  <TooltipTrigger render={
                    <div
                      ...
                      className={cn(
                        ...
                        isActiveProject ? "bg-primary/15" : "hover:bg-muted/50"
                      )}
                    >
                      <div
                        ...
                        style={{
                          ...
                          color: accent,
                          boxShadow: isActiveProject ? `0 0 0 1.5px ${accent}55` : undefined,
                        }}
                      >
                ...
                {isExpanded && (
                  <div className="ml-4 pl-3 border-l border-border/30 space-y-0.5 my-0.5">
                    {projectPods.length > 0 && (
                      <p className="px-2 pt-0.5 pb-0.5 text-[9px] font-bold text-muted-foreground/40 uppercase tracking-widest flex items-center gap-1">
                      ...
                      projectPods.map(pod => {
                        ...
                        return (
                          <div
                            ...
                            style={isPodActive ? {
                              backgroundColor: `color-mix(in oklch, ${pod.color} 15%, transparent)`,
                            } : undefined}
                          >
                            <Layers
                              className="w-3.5 h-3.5 shrink-0 transition-colors"
                              style={{ color: isPodActive ? pod.color : undefined }}
                            />
